...
Route::get('posts/{id}:with-cache', [PostsController::class, 'getWithCache']);
Route::get('posts/{id}:with-tag-cache', [PostsController::class, 'getWithTagCache']);
...
Route::post('send-kafka-message', [KafkaController::class, 'sendMessage']);
